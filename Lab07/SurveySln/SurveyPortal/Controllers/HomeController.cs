...
namespace SurveyPortal.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly IHubContext<SurveyResultsHub> _surveyHub;
        public const int PageSize = 4;

        public HomeController(ISurveyRepository repository, IHubContext<SurveyResultsHub> surveyHub)
        {
            _repository = repository;
            _surveyHub = surveyHub;
        }
        ...
        [HttpPost]
        [Authorize]
        public async Task<IActionResult> SaveSurveyAnswer(long SurveyID, string Answer)
        {
            ...
            await _surveyHub.Clients
                .Group(SurveyResultsHub.GetGroupName(SurveyID))
                .SendAsync("ReceiveAnswer", new SurveyAnswerMessage
                {
